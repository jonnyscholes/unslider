  ...
  (function($, f) {
    var Unslider = function() {
      ...
      _.o = {
        ...
        cssSize: true // set to false to allow manual height/width of slider container and elements
      };
      ...
      function nav(name, html) {
        if (name == 'dot') {
          $.each(_.li, function(index) {
            html.append('<li class="' + (index == _.i ? name + ' active' : name) + '">' + ++index + '</li>');
          });
        } else {
          html = '<div class="';
        ...
        _.el.addClass('has-' + name + 's').find('.' + name).click(function() {
          console.log('foo');
          var me = $(this);
